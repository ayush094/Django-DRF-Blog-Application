...
class Blog(models.Model):
    ...
    ai_summary = models.TextField(
        null=True,
        blank=True,
        help_text="AI-generated summary of the blog"
    )
    ai_improved_content = models.TextField(
        null=True,
        blank=True,
        help_text="AI-improved version of the blog content"
    )
    ai_generated = models.BooleanField(
        default=False,
        help_text="Indicates if the blog content was generated by AI"
    )
    ai_generation_prompt = models.TextField(
        null=True,
        blank=True,
        help_text="Prompt used to generate this blog via AI"
    )
